...
def error_days():
    ...
    for row in statement3:
        print('   On ' + row[1] + " - " + str(row[0]) +
              '% of requests were errors')
    db.close()

# ------------------------------


print("Running Log Analysis, Please be patient as we calculate your queries")
print('---///---///---///---')
top_three_posts()
popular_authors()
error_days()

# extra notes: list all CREATE VIEW commands in the README file so the
# reviewer can re-create them
